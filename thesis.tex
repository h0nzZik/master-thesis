...
abstract = {Modern programming languages are really expressive, but also complex.
	...
	The thesis consists of the following parts. First, because \K is not widely known, we provide a mini-tutorial on how \K can be used to write an interpreter of a simple language. Second, we briefly explain the relevant C++ features from the language point of view. Third, we describe our implementation and its limitations. Fourth, we discuss the defects in major C++ compilers we found during the implementation effort.
},
keywords = {C++, semantics, enumerations, constant expressions, constexpr, K framework, formal methods},
