...
C++ is a ,,general purpose programming language''~\cite{bjarne-cpp} originally created by Bjarne Stroustrup in the years between 1979 and 1983~\cite{bjarne-faq}. After some time, many independent implementation emerged, and in 1998 the language was standardized as ISO/IEC 14882:1998 international standard (\cite{ISOcpp98}); that version is now known as C++98.

The language changed a lot since that time and it is still evolving. Compiler developer, standard library writers, members of the standardization committee... Once in a while, a new ISO standard is released. In 2014, ...

Besides the ISO standards, the committee regularly issues a working draft of the standard, which can be  downloaded freely
\footnote{\url{https://isocpp.org/std/the-standard}}
