...
\item Before other initializations of variables with non-static storage duration. Programmers may know this in a simplified form as a rule ,,in C/C++, global variables are initialized to zero''.
\end{itemize}
